            ...
            <ResponsiveContainer width="100%" height={300}>
              <PieChart>
                <Pie
                  ...
                  dataKey="amount"
                >
                  {trends.trends.slice(0, 8).map((entry, index) => (
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            <div>
              ...
              <Select value={timeframe} onValueChange={(value: TrendTimeframe) => setTimeframe(value)}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
            ...
            <div>
              ...
              <Select value={analysisType} onValueChange={(value: TrendAnalysisType) => setAnalysisType(value)}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
                  ...
                  <table className="w-full border-collapse border border-gray-300">
                    <thead>
                      <tr className="bg-gray-50">
                        ...
                        {analysisType === 'category' && <th className="border border-gray-300 px-4 py-2 text-left">Category</th>}
                        ...
                        {analysisType === 'anomaly' && <th className="border border-gray-300 px-4 py-2 text-center">Anomaly</th>}
                      </tr>
                    </thead>
                    <tbody>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-4">
                      <div className="p-4 bg-green-50 rounded-lg">
                        <h4 className="font-semibold text-green-800 mb-2">Next Period Projection</h4>
